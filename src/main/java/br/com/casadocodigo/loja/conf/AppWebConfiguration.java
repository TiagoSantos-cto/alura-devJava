...
@EnableWebMvc
@ComponentScan(basePackageClasses = {HomeController.class, ProdutoDAO.class, UsuarioDAO.class, FileSaver.class, CarrinhoCompras.class, RelatorioProdutosController.class})
@EnableCaching
